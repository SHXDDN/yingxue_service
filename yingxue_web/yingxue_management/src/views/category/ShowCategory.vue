  ...
  <div >
    ...
    <div ><br>
      <div class="service-center">
        ...
        <!--       添加类别  父表格       -->
        <router-link :to="{name:'AddCategory'}"  ><el-button type="primary">添加一级类别</el-button></router-link><br><br>

        <!--    父表格  开始    -->
        <el-table border :data="oneCategorys" @expand-change="expandChange" v-loading="loading" style="width: 100%" >
...
export default {
  ...
  data(){  //数据
    return {
      ...
      twoPageSize:2,   //选择每页展示条数  必须在pageSizes中
      oneCategoryId:"",
    }
  },
  created() {  //初始化页面触发函数
    ...
    /*this.oneCategorys=[
      {"id":"12","cateName":"Java","levels":1,"parentId":"11",},
      {"id":"13","cateName":"GO","levels":1,"parentId":"11"},
      {"id":"15","cateName":"Python","levels":1,"parentId":"11"},
    ]*/
    ...
    /*this.oneCategorys=[
      {
        "id":"12",
        "cateName":"Java",
        "levels":1,"parentId":"11",
        children:[
          {"id":"33","cateName":"二级类别","levels":2,"parentId":"12"},
          {"id":"34","cateName":"二级类别","levels":3,"parentId":"12"},
          {"id":"35","cateName":"二级类别","levels":4,"parentId":"12"},
        ]
      },
      {"id":"13","cateName":"GO","levels":1,"parentId":"11"},
      {"id":"15","cateName":"Python","levels":1,"parentId":"11"},
