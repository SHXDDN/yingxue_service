<template>
  ...
  <div >
    ...
    <router-link :to="{name:'AddVideo'}"  ><el-button type="primary">添加视频</el-button></router-link><br><br>
      ...
      <!--   表单数据展示   -->
      <el-table border style="width: 100%" :row-class-name="tableRowClassName" :data="videos.filter(data => !search || data.title.toLowerCase().includes(search.toLowerCase()))">

        <!--    复选框列    -->
        <el-table-column type="selection" width="55"></el-table-column>
        <!--    数据列    -->
        <el-table-column prop="id" label="视频id" width="100" sortable></el-table-column>
        <el-table-column prop="title" label="标题" width="80"></el-table-column>
        <el-table-column prop="description" label="描述"></el-table-column>

        <el-table-column prop="coverPath" label="视频"  width="350" >
          <template slot-scope="scope">
            <video :ref="'videoPlayer' + index" controls="controls" width="300" height="200px" :src="scope.row.videoPath">
<!--              <source :src="scope.row.videoPath" type="video/mp4">您的浏览器不支持Video标签。-->
        ...
        <el-table-column prop="groupId" label="分组Id" sortable></el-table-column>
